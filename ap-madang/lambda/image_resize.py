...
def update_thumbnail(meeting_id, thumbnail_image_url):
    # db setting
    try:
...
def lambda_handler(event, context):
    for record in event["Records"]:
        ...
        update_thumbnail(meeting_id, thumbnail_image_url)
        logger.info(
            "----- sucessfully uploaded file {} -----".format(thumbnail_image_url)
        )
